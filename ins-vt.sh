...
# install v2ray
wget https://raw.githubusercontent.com/egirahmadi/coding/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget -O del-ws "https://raw.githubusercontent.com/egirahmadi/coding/del-ws.sh"
